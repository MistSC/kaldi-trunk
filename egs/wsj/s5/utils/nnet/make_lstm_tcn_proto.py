...
parser.add_option('--feat-dim3', dest='feat_dim3', type='int', default=1,
                  help='Number of LSTM input dimension 3 [default: %default]');                 
...
parser.add_option('--num-cells-dim3', dest='num_cells_dim3', type='int', default=1, 
                  help='Number of LSTM cells dimension 3 [default: %default]');
...
parser.add_option('--num-recurrent-dim3', dest='num_recurrent_dim3', type='int', default=1, 
                   help='Number of LSTM recurrent units dimension 3 [default: %default]');
...
assert(feat_dim == o.feat_dim1 * o.feat_dim2 * o.feat_dim3);
...
if o.num_layers == 1:
    print "<LstmTcnProjectedStreams> <InputDim> %d <OutputDim> %d <CellDim> %d <InputDim1> %d <InputDim2> %d <InputDim3> %d <CellDim1> %d <CellDim2> %d <CellDim3> %d <OutputDim1> %d <OutputDim2> %d <OutputDim3> %d <ParamScale> %f <ClipGradient> %f" % \
        (feat_dim, o.num_recurrent_dim1*o.num_recurrent_dim2*o.num_recurrent_dim3, o.num_cells_dim1*o.num_cells_dim2*o.num_cells_dim3, \
        o.feat_dim1, o.feat_dim2, o.feat_dim3, o.num_cells_dim1, o.num_cells_dim2, o.num_cells_dim3, o.num_recurrent_dim1, o.num_recurrent_dim2, o.num_recurrent_dim3, \
    ...
    print "<LstmTcnProjectedStreams> <InputDim> %d <OutputDim> %d <CellDim> %d <InputDim1> %d <InputDim2> %d <InputDim3> %d <CellDim1> %d <CellDim2> %d <CellDim3> %d <OutputDim1> %d <OutputDim2> %d <OutputDim3> %d <ParamScale> %f <ClipGradient> %f" % \
        ...
        o.lstm_stddev_factor, o.clip_gradient)
    print "<LstmTcnProjectedStreams> <InputDim> %d <OutputDim> %d <CellDim> %d <InputDim1> %d <InputDim2> %d <InputDim3> %d <CellDim1> %d <CellDim2> %d <CellDim3> %d <OutputDim1> %d <OutputDim2> %d <OutputDim3> %d <ParamScale> %f <ClipGradient> %f" % \
        (o.num_recurrent_dim1*o.num_recurrent_dim2*o.num_recurrent_dim3, o.num_recurrent_dim1*o.num_recurrent_dim2*o.num_recurrent_dim3, o.num_cells_dim1*o.num_cells_dim2*o.num_cells_dim3, \
        o.num_recurrent_dim1, o.num_recurrent_dim2, o.num_recurrent_dim3, o.num_cells_dim1, o.num_cells_dim2, o.num_cells_dim3, o.num_recurrent_dim1, o.num_recurrent_dim2, o.num_recurrent_dim3, \
        o.lstm_stddev_factor, o.clip_gradient)
else:
...
print "<AffineTransform> <InputDim> %d <OutputDim> %d <BiasMean> 0.0 <BiasRange> 0.0 <ParamStddev> %f" % \
    (o.num_recurrent_dim1 * o.num_recurrent_dim2 * o.num_recurrent_dim3, num_leaves, o.param_stddev_factor)
